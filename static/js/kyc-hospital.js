...
function saveHospitalStep1_old2() {
  const formData = new FormData();

  formData.append("step", "1");

  formData.append("hos_name", $("#hos_name").val());
  formData.append("hos_email", $("#hos_email").val());
  formData.append("hos_country_code_val", $("#hos_country_code_val").val());
  formData.append("hos_phn", $("#hos_phn").val());
  formData.append("phone_otp_verified", $("#phone_otp_verified").val());
  ...
  formData.append("hos_address", $("#hos_address").val());
  formData.append("hos_country", $("#hos_country").val());
  formData.append("hos_state", $("#hos_state").val());
  formData.append("hos_city", $("#hos_city").val());
  formData.append("hos_pincode", $("#hos_pincode").val());
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response.success === true) {
        ...
        console.log("Step 2 loaded");
        console.log("Step 2 element:", $("#step-panel-2").length);
      } else {
        toastr.error(response.message || "Unable to save hospital details.");
      }
    },
    ...
    complete: function () {
      ...
      // Don't change the text if we are already on Step 2
      if (currentStep !== totalSteps) {
        $("#hos-next-btn-text").text("Save & Continue");
      }
    },
...
function saveHospitalStep1_old() {
  const formData = new FormData();
...
function saveHospitalStep2() {
  ...
  formData.append("hos_adm_name", $("#hos_adm_name").val());
  formData.append("hos_adm_email", $("#hos_adm_email").val());
  formData.append("hos_phone_country_code", $("#hos_phone_country_code").val());
  formData.append("hos_phone", $("#hos_phone").val());
  ...
  formData.append("hos_personal_pincode", $("#hos_personal_pincode").val());
