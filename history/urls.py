...
urlpatterns = [
    ...
    path("lab/complete/", views.complete_lab_appointment, name="complete_lab_appointment"),
    path("lab/cancel/", views.cancel_lab_appointment, name="cancel_lab_appointment"),
]
